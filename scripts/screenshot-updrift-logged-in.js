...
async function takeLoggedInScreenshots() {
  console.log('🚀 Starting logged-in screenshot capture of updrift.me...');
  ...
  try {
    ...
    if (!loginButton) {
      ...
      console.log('📝 Please provide login credentials manually');
      ...
      console.log('📸 Screenshot saved: updrift-login-page.png');
      console.log('💡 You can manually log in and then run this script again');
      return;
    }
    ...
    // Fill in email (you'll need to provide your actual email)
    console.log('📧 Filling in email...');
    await emailField.type('your-email@example.com'); // Replace with your actual email
    ...
    // Fill in password (you'll need to provide your actual password)
    console.log('🔐 Filling in password...');
    await passwordField.type('your-password'); // Replace with your actual password
