...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background-light/20 dark:bg-[#323849]/20 backdrop-blur-sm border-b border-surface-light/20 dark:border-transparent px-4 sm:px-6 md:px-8">
