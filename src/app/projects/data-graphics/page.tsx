  ...
  return (
    <article className="max-w-[100rem] mx-auto px-4 md:px-12 lg:px-20 pb-12 md:pb-24 lg:pb-40 text-[#0f172a] dark:text-white">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <p className="text-[1.125rem] text-text-light/80 dark:text-text-dark/80">
            Rather than another chart library, this is a <strong className="text-text-light dark:text-text-dark">visual grammar</strong> plus <strong className="text-text-light dark:text-text-dark">implementation proof</strong>. Grounded in Wilkinson's Grammar of Graphics, the system defines primitives that compose—not templates that constrain.
          </p>
          <p className="text-[1.125rem] text-text-light/80 dark:text-text-dark/80">
      ...
      >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
            <div>
              ...
              <p className="text-[1.125rem] text-text-light/80 dark:text-text-dark/80">
                Everything captured in <code className="px-1.5 py-0.5 bg-text-light/10 dark:bg-text-dark/10 rounded text-sm font-mono">tokens.json</code> (W3C format) for import via Tokens Studio—so design decisions propagate to implementation automatically.
              </p>
            </div>
            <div className="p-5 bg-text-light/5 dark:bg-text-dark/5 border border-text-light/10 dark:border-text-dark/10 rounded-xl">
        ...
        <div className="mb-16">
          ...
          <Callout>
            <p className="text-[1.125rem] font-semibold text-teal-900 dark:text-teal-200 mb-2">Identified and resolved a coordinate system issue during programmatic generation.</p>
            <p className="text-[1.0625rem] text-text-light/80 dark:text-text-dark/80">
        ...
        <div className="mb-16">
          ...
          <Callout>
            <p className="text-[1.125rem] font-semibold text-teal-900 dark:text-teal-200 mb-2">Systematic quality assurance: the spacing audit.</p>
            <p className="text-[1.0625rem] text-text-light/80 dark:text-text-dark/80">
              Initial chart specs used <code className="px-1 py-0.5 bg-text-light/10 dark:bg-text-dark/10 rounded text-sm font-mono">padding: 5</code> instead of the documented <code className="px-1 py-0.5 bg-text-light/10 dark:bg-text-dark/10 rounded text-sm font-mono">&#123;top: 10, left: 60, right: 20, bottom: 40&#125;</code>. I ran a systematic audit and standardized <code className="px-1 py-0.5 bg-text-light/10 dark:bg-text-dark/10 rounded text-sm font-mono">labelPadding: 8px</code> and <code className="px-1 py-0.5 bg-text-light/10 dark:bg-text-dark/10 rounded text-sm font-mono">symbolOffset: 8px</code> across all files. Documentation and code must align.
            </p>
          </Callout>
        </div>
      </motion.section>
