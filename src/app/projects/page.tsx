          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[...allProjects]
              ...
              <ProjectCard
                ...
                project={project}
                variant="glass"
                className="relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[linear-gradient(110deg,rgba(255,255,255,0)_20%,rgba(26,54,93,0.18)_33%,rgba(200,80,192,0.18)_44%,rgba(35,189,184,0.18)_55%,rgba(255,255,255,0)_68%)] before:opacity-0 before:translate-x-[-60%] hover:before:opacity-100 hover:before:translate-x-[120%] before:transition before:duration-500 before:ease-out before:pointer-events-none before:blur-[20px] motion-reduce:before:opacity-0 motion-reduce:hover:before:opacity-0"
              />
            ))}
          </div>
        </section>
