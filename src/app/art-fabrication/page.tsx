...
export default function ArtFabrication2Page() {
  ...
  return (
    <main className="min-h-screen w-full text-text-light dark:text-text-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-16 relative z-10">
