  ...
  data: [
    {
      ...
      values: [
        ...
        { time: '02:00', value: 48.1 },
        { time: '04:00', value: 52.3 },
        { time: '06:00', value: 68.5 },
        { time: '08:00', value: 82.4 },
        { time: '10:00', value: 78.9 },
        { time: '12:00', value: 85.2 },
        { time: '14:00', value: 79.8 },
        { time: '16:00', value: 72.4 },
        { time: '18:00', value: 65.1 },
        { time: '20:00', value: 58.3 },
        { time: '22:00', value: 51.2 },
  ...
  data: [
    {
      ...
      transform: [
        { type: 'fold', fields: ['Production', 'Staging', 'Development'], as: ['series', 'value'] },
      ],
    },
  ],
  scales: [
...
export const chart5Spec = {
  ...
  scales: [
    ...
    },
    {
      name: 'x',
      type: 'linear',
      domain: { data: 'table', field: 'requests' },
      range: 'width',
      nice: true,
      zero: true,
    },
  ...
  marks: [
    {
      ...
      encode: {
        enter: {
          y: { scale: 'y', field: 'endpoint' },
          height: { scale: 'y', band: 1 },
          x: { scale: 'x', value: 0 },
          x2: { scale: 'x', field: 'requests' },
          fill: { value: '#3B82F5' },
          cornerRadiusTopRight: { value: 3 },
...
export const chart7Spec = {
  ...
  scales: [
    ...
    },
    {
      ...
      range: ['#22BF4A', '#F2CB05', '#F28500', '#CC3D3D'],
    },
  ],
  axes: [
    {
